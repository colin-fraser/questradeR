...
An R interface to the [Questrade API](https://www.questrade.com/api/documentation/getting-started).
...
Follow the [Getting Started directions in the Questrade API documentation](https://www.questrade.com/api/documentation/getting-started). Then run `qt_init()` to initialize `questradeR`. This will walk you through the process of getting and setting your API keys.
